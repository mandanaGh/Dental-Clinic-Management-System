...
{
    public partial class EquipmentShortageAlarmUI : Form
    {        
        EquipmentBLL _EquipmentBLL = new EquipmentBLL();
        ExceptionHandlerBOL _ExceptionHandlerBOL;
        public EquipmentShortageAlarmUI()
        {
            InitializeComponent();
            FillAlaramGridEX();
        }
        private void FillAlaramGridEX()
        {
            ...
            try
            {
                EquipmentBOL[] _EquipmentBOL = _EquipmentBLL.SelectShortageAlarm();
        ...
        private void EquipmentShortageAlarmUI_KeyDown(object sender, KeyEventArgs e)
        {
